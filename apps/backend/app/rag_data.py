...
CORE_LAWS: dict[str, str] = {
    ...
    "admin_basic": "행정기본법",
    "admin_proc": "행정소송법",
    "housing_rental": "주택임대차보호법",
    "labor_standards": "근로기준법",
    "privacy": "개인정보보호법",
    # Phase 2: 도메인 특화
    "commercial_rental": "상가건물임대차보호법",
    "family_proc": "가사소송법",
    "info_network": "정보통신망법",
    "domestic_violence": "가정폭력처벌특례법",
    "sexual_violence": "성폭력처벌특례법",
    "youth_protection": "청소년보호법",
...
_LAW_API_TITLE_OVERRIDE: dict[str, str] = {
    ...
    "housing_rental": "주택임대차보호법",
    "privacy": "개인정보 보호법",
    "commercial_rental": "상가건물 임대차보호법",
    "info_network": "정보통신망 이용촉진 및 정보보호 등에 관한 법률",
    "domestic_violence": "가정폭력범죄의 처벌 등에 관한 특례법",
    "sexual_violence": "성폭력범죄의 처벌 등에 관한 특례법",
...
PRECEDENT_SEED_QUERIES: dict[str, list[str]] = {
    ...
    "civil_proc": [
        "관할", "소장", "답변서", "준비서면", "변론", "증거", "증인신문",
        "서증", "감정", "판결", "항소", "상고", "집행", "보전처분", "가압류",
        "가처분", "조정", "화해",
    ],
    "criminal_proc": [
        "수사", "체포", "구속", "영장", "기소", "공소장", "공판", "증거능력",
        "위법수집증거", "자백배제", "전문법칙", "공판중심주의", "무죄추정",
        "항소", "상고", "재심",
    ],
    "admin_basic": [
        "행정행위", "처분", "재량", "신뢰보호", "비례원칙", "평등원칙",
        "법치행정", "행정입법",
    ],
    "admin_proc": [
        "취소소송", "무효확인소송", "부작위위법확인", "집행정지",
        "원고적격", "피고적격", "협의의 소익", "처분성",
    ],
    "housing_rental": [
        "전세", "월세", "보증금", "대항력", "우선변제권", "최우선변제",
        "묵시적 갱신", "계약갱신요구권", "임차권등기명령",
    ],
    "labor_standards": [
        "해고", "부당해고", "퇴직금", "임금체불", "연장근로", "야간근로",
        "휴게시간", "연차휴가", "최저임금", "산재",
    ],
    "privacy": [
        "개인정보 수집", "동의", "정보유출", "가명정보", "민감정보",
        "고유식별정보", "개인정보 파기", "정보주체 권리",
    ],
    "commercial_rental": [
        "상가 임대차", "권리금", "계약갱신요구권", "환산보증금",
        "대항력", "상가건물",
    ],
    "family_proc": [
        "이혼", "협의이혼", "재판상 이혼", "양육권", "친권", "양육비",
        "재산분할", "상속", "유류분", "친자확인",
    ],
    "info_network": [
        "정보통신망", "개인정보 유출 통지", "해킹", "악성프로그램",
        "스팸메일", "불법정보", "명예훼손 정보",
    ],
    "domestic_violence": [
        "가정폭력", "접근금지", "격리", "임시조치", "피해자보호명령",
    ],
    "sexual_violence": [
        "성폭력", "강간", "강제추행", "성착취", "카메라등이용촬영",
        "통신매체이용음란", "신상정보공개",
    ],
    "youth_protection": [
        "청소년 유해매체물", "청소년 유해업소", "청소년 고용",
        "청소년 유해약물",
    ],
    "capital_market": [
        "증권", "금융투자업", "투자자보호", "불공정거래", "시세조종",
        "내부자거래", "공시의무",
    ],
    "bankruptcy": [
        "개인회생", "파산", "면책", "회생계획", "채권자집회",
        "부인권", "회생채권",
    ],
    "medical": [
